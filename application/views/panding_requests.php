...
<body>
                            ...
                            <table>
                                ...
                                <?php foreach($pendingapprove as $row): ?>
                                    <tr>
                                        ...
                                        <form action="<?php echo base_url('Admin_controller/approve_publisher/' . $row->s_no); ?>" method="post">
                                            ...
                                            <button type="button" class="btn btn-danger demo" value='<?= $row->s_no?>'>another</button>
    ...
    $(document).ready(function(){
        $('.decline').click(function(e){
            ...
            $.ajax({
                type: "DELETE",
                url: '<?=base_url('Pubroute_controller/delete_publisher/')?>' + id,
                ...
                error: function(xhr, status, error) {
                    ...
                    console.log("the error ",xhr.responseText);
                }
            });
        });
    });
